...
@Composable
fun ProfileKarmaPointsScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text(text = "You have ${uiState.karmaPoints} Good Deed points. Keep donating more to earn more points", modifier = modifier.padding(horizontal = 16.dp), style = MaterialTheme.typography.bodyMedium, color = PrimaryTextColor)
