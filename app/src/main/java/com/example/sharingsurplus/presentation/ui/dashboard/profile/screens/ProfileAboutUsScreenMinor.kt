...
@Preview
@Composable
private fun ProfileAboutUsScreenMinorPreview() {
    ProfileAboutUsScreenMinor(painter = painterResource(id = R.drawable.ic_sharing_surplus_logo))
}